...
class ProductFixtures extends Fixture
{
    ...
    public function load( ObjectManager $manager)
    {
        ...
        $product
            ...
            ->setDescription("L’iPhone 7 est le dernier né de la célèbre gamme de smartphones d’Apple. Si celui-ci reprend les mêmes dimensions et à peu près le même aspect que son prédécesseur l’iPhone 6s, il le surpasse de loin. En effet, un iPhone 7 noir 128 go embarque plusieurs innovations, que ce soit au niveau du chipset, de l’écran, des capteurs photographiques et de l’iPhone en lui-même. Sous sa belle coque élégante, l’iPhone 7 cache un redoutable chipset, qui est l’Apple A10 Fusion. Son processeur central intègre deux cœurs à haute performance et deux cœurs à haute efficacité énergétique. La vitesse d’exécution de applications est alors deux fois supérieure à celle de l’Apple A8 de l’iPhone 6 et le SoC consomme jusqu’à cinq fois moins d’énergie.")
            ->setPrice("49990")
            ->setStock("12");
        $product->addClient($this->getReference('client1'));
        $manager->persist($product);
